...
function UserMypage() {
  ...
  return (
    <>
      <UserCard className="cntMarginTop cntMarginBottom" userMyCard={true} />
        ...
        <div className="memberWrap">
          <div className="memberTab">
            <div
              ...
              className={memberButton === "member1" ? "active" : ""}
            >
            ...
            <div
              ...
              className={memberButton === "member2" ? "active" : ""}
            >
              ...
              <div
                ...
                className={memberButton === "member4" ? "active" : ""}
              >
            ...
            <div className="memberInfo">
              ...
              {memberButton === "member2" && (
                <div>
                  ...
                  <p>
                    <span>혜택</span>
                    별숲에서 캠핑장 예약, 캠핑 용품 구매시 자동 10% 할인
                  </p>
                  <p>
                    <span>기준</span>
              ...
              {memberButton === "member3" && (
                <div>
                  ...
                  <p>
                    <span>혜택</span>
                    별숲에서 캠핑장 예약, 캠핑 용품 구매시 자동 20% 할인
                  </p>
                  <p>
                    <span>기준</span>
              ...
              {memberButton === "member4" && (
                <div>
                  ...
                  <p>
                    <span>혜택</span>
                    별숲에서 캠핑장 예약, 캠핑 용품 구매시 자동 30% 할인
                  </p>
                  <p>
                    <span>기준</span>
