        ...
        <div className="storeViewWrap">
            <div className="productImageWrap">
                <img
                    ...
                    src={
                        process.env.PUBLIC_URL +
                        `/assets/images/${productview.image}`
                    }
            ...
            <div className="toggle">
                <StoreToggle className="toggleWrap" title="교환ㆍ반품 안내">
                    ...
                    <div className="togglecontentWrap">
                        <p className="togglecontent">
                            교환ㆍ반품 신청 가능 기간
                        </p>
                        <p className="productReference">
                            -구매자 단순 변심은 상품 수령후 7일 이내 (구매자
                            반품 배송비 부담)
                        </p>
                        <p className="productReference">
                            -표시ㆍ광고와 상이, 계약 내용과 다르게 이행된 경우
                            상품 수령 후 <br />
                            3개월 이내 혹은 표시ㆍ광고와 다른 사실을 안 날로부터
                            30일 이내 <br />
                            (판매자 반품 배송비 부담) 둘 중 하나 경과시
                            반품ㆍ교환 불가
                        </p>
                    </div>
                </StoreToggle>
