    ...
    <>
      <div>
        <div className="campViewSwiper">
          ...
          >
            <Icon iconName={isLiked ? "heartActive" : "heartActive"} />
          </div>
        </div>
        <ul className="campViewWrap">
          <li>
            <ul className="campTitle">
              <li>
                {campItem.is_auto === true ? <span>오토캠핑장</span> : null}
                {campItem.is_glamp === true ? <span>글램핑</span> : null}
                {campItem.is_carvan === true ? <span>카라반</span> : null}
              </li>
              <li>{campItem.name}</li>
            </ul>
          </li>
          ...
          <li>
            ...
            {campItem.homepage && campItem.homepage.trim() !== "" ? (
              <button onClick={() => window.open(campItem.homepage, "_blank")}>
                홈페이지 바로가기
              </button>
            ) : null}
          </li>
          ...
          <li>
            <CampTag tags={campItem.themaEnvrnCl} isListPage={false} />
          </li>
        </ul>
