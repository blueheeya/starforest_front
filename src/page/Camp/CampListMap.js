  ...
  const [circles, setCircles] = useState([
    {
      ...
      addr1: "경기 가평군 설악면 1111 61-75",
      mapX: 127.4947241,
      mapY: 37.5978864,
    },
    {
      name: "1111 카라반 글램핑 풀 캠핑장",
      addr1: "경기 가평군 설악면 2222 61-75",
      mapX: 126.6806875,
      mapY: 37.3241008,
    },
    {
      name: "2222 카라반 글램핑 풀 캠핑장",
      addr1: "경기 가평군 설악면 3333 61-75",
      mapX: 127.455147,
      mapY: 37.50762979,
    },
    {
      name: "3333 카라반 글램핑 풀 캠핑장",
      addr1: "경기 가평군 설악면 4444 61-75",
      mapX: 127.4947099,
      mapY: 37.6012926,
    },
    {
      name: "4444 카라반 글램핑 풀 캠핑장",
      addr1: "경기 가평군 설악면 5555 61-75",
      mapX: 127.5124645,
      mapY: 37.7467558,
    },
    {
      name: "5555 카라반 글램핑 풀 캠핑장",
      addr1: "경기 가평군 설악면 6666 61-75",
      mapX: 126.9161565,
      mapY: 37.25773423,
    },
    {
      name: "6666 카라반 글램핑 풀 캠핑장",
      addr1: "경기 가평군 설악면 7777 61-75",
      mapX: 127.1889864,
      mapY: 37.9617314,
    },
    {
      name: "7777 카라반 글램핑 풀 캠핑장",
      addr1: "경기 가평군 설악면 8888 61-75",
      mapX: 127.5140734,
      mapY: 37.8552141,
    },
  ]); //모임 배열
  ...
  const initializeMarkers = (map) => {
    ...
    if (circles && circles.length > 0) {
      ...
      for (let i = 0; i < circles.length; i++) {
        let latlng = new kakao.maps.LatLng(circles[i].mapY, circles[i].mapX);
        // console.log(latlng);
